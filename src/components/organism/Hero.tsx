...
const Hero: FC<HeroProps> = ({}) => {
  return (
    <section
      id="home"
      className="w-full bg-cover bg-center flex flex-col justify-center items-center min-h-[60vh] 2xl:min-h-[80vh] mb-[-40px] px-4"
      style={{
        backgroundImage: 'url("/bg-familia-abfn.jpg")', // Caminho para a imagem na pasta public
      }}
    >
      {/* Título */}
